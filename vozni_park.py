...
"""list of vehicles with all attributes"""
...
"""KM and/or registration date correction"""
...
user_input_new_vehicle = raw_input("Would you like to add new vehicle? d/n")
while user_input_new_vehicle == "d":
    ...
    user_input_new_vehicle = raw_input("Would you like to add another vehicle in a list? d/n")

print vehicle_list

user_del_item = raw_input("which item would you like to remove from list? ")
for item in vehicle_list:
